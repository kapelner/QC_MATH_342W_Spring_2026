...
* Print out the numerical constant pi with ten digits after the decimal point using the internal constant `pi` and the `options` command. Make sure you reset the `options` afterwards.
