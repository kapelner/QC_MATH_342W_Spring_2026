...
* This file if you note has an .Rmd extension meaning "R Markdown". Markdown is a way of typesetting simple documents with basic code directives. You can read up on this by yourself. "R Markdown" is a document type that combines R code within markdown documents where the R code is in "chunks".
